<%@ Page Title="Pesquisa de Empresas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmpresaPesquisa.aspx.cs" Inherits="TesteS4E.EmpresaPesquisa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section>
        ...
        <div class="container-fluid">
            ...
            <%-- Grid Empresas --%>
            <div class="row mt-4">
                <asp:GridView ID="gridEmpresas" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="10"
                    CssClass="table table-striped" DataKeyNames="Id" HeaderStyle-HorizontalAlign="Center" OnRowCommand="GridEmpresas_RowCommand"
            ...
            <%-- Grid Associados --%>
            <asp:Panel ID="panelGridAssociados" runat="server" Visible="false">
                <div class="row mt-4">
                ...
                <div class="row mt-4">
                    <asp:GridView ID="gridAssociados" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                        ...
                        OnRowDataBound="GridAssociados_RowDataBound" EmptyDataText="Nenhuma empresa encontrada!">
                        <Columns>
